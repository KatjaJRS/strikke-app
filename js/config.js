...
const translations = {
  en: {
    ...
    registerErrorServerSetup: 'Sign-up is temporarily unavailable due to server setup. Please contact the admin.',
  ...
  da: {
    ...
    registerErrorServerSetup: 'Oprettelse er midlertidigt utilgaengelig pga. serveropsaetning. Kontakt admin.',
